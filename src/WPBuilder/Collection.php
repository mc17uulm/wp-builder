...
class Collection
{
    ...
    public function get($key) {
        if(!isset($this->list[$key])) {
            throw new Exception("Key ($key) not in collection");
        }
    ...
    {
        if(!isset($this->list[$key])) {
            throw new Exception("Key ($key) is not in collection");
        }
        unset($this->list[$key]);
        return $this;
    }
    ...
    {
        return new Collection(array_map($callable, $this->list, array_keys($this->list)));
    }
